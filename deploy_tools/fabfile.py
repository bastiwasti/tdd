...
REPO_URL = 'https://github.com/bastiwasti/tdd.git'

def deploy():
    site_folder = '/home/%s/sites/%s' % (env.user, env.host)
    source_folder = site_folder + '/source'
    _create_directory_structure_if_necesarry(site_folder)
...
def _create_directory_structure_if_necesarry(site_folder):
